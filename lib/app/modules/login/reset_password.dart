          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                height: Dimens.hundred*4.95,
                decoration: const BoxDecoration(
                    image: DecorationImage(image: AssetImage('assets/img/reset.png'), fit: BoxFit.cover)
                ),
              ),
              Dimens.boxHeight15,
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Dimens.boxHeight10,
                    Dimens.boxHeight20,
                    PrimaryButton(text: 'SEND RESET LINK', onPress: (){
                      RoutesManagement.goToConfirmPasswordView();
                    },),
                    Dimens.boxHeight20,
                    Row(
