...
void materialRequestFilterBottomSheet() => Get.bottomSheet(
  barrierColor: ColorsValue.barrierColor,
  GetBuilder<MaterialRequestController>(
      builder: (logic) {
        return Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            SizedBox(
                              ...
                              width: Dimens.twenty,
                              child: Checkbox(value: logic.filterIndex.contains(i), onChanged: (value){
...
void sortByBottomSheet() => Get.bottomSheet(
  ...
  GetBuilder<MaterialRequestController>(
      builder: (logic) {
        return Container(
          width: Dimens.screenWidth,
          height: Dimens.hundred * 2.43,
          color: Colors.transparent,
          child: Column(
            children: [
              const CircularCancelButton(),
              Container(
                height: Dimens.hundred * 1.91,
                width: Dimens.screenWidth,
                color: ColorsValue.lightGray,
                child: Column(
                  children: [
                        ...
                        child:  InkWell(
                          ...
                          child: Row(
                            children: [
                              ...
                              const Spacer(),
                              _sortByIndicator(logic.sortByIndex == i?ColorsValue.green: Colors.black,)
                            ],
                          ),
                        ),
                      ),
