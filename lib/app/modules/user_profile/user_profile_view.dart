...
import 'package:branchx/app/modules/user_profile/local_widget.dart';
...
import 'package:branchx/app/utils/utility.dart';
...
class UserProfileView extends StatelessWidget {
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text(
                    'Location',
                    style: Styles.white18.copyWith(fontWeight: FontWeight.w500),
                  ),
                  const Spacer(),
                  Text(
                    'JP Nagar, 7th Phase',
              ...
              Container(
                ...
                child: Center(child: Image.asset('assets/img/location-pin.png')),
              )
              // Dimens.boxWidth20,
            ],
          ),
  ...
  Widget _attendanceTitle() => Padding(
        padding: const EdgeInsets.only(top: 12.0, left: 20, right: 20),
        child: Row(
          children: [
            Text(
      ...
      child: Column(
        children: [
          ...
          TableCalendar(
            ...
            lastDay: DateTime.now().add(const Duration(days: 60, hours: 23)),
            focusedDay: DateTime.now(),
            calendarFormat: CalendarFormat.month,
            onDaySelected: (value1, value2) {
              int date = int.parse('$value1'.split('-')[2].split(' ')[0]);
              // Utility.printDLog('$date');
              if(date%3 == 0){
                birthdayBottomSheet();
              }else if(date%4 == 0){
                holidayBottomSheet();
              }else if(date%5 == 0){
                extraWorkingBottomSheet();
              }else{
                loginLocationBottomSheet();
              }
            },
          ...
          Column(
            ...
            children: [
              ...
              Text(
                "March",
                style:
                    Styles.blackGrey12.copyWith(color: const Color(0xFF747378)),
              )
            ],
          ),
          const Spacer(),
