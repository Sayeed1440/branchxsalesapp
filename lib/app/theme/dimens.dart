...
abstract class Dimens {
  ...
  static double fiftySeven = 57.r;
  static double fiftyNine = 59.r;
  ...
  static EdgeInsets edgeInsets16_4 = EdgeInsets.symmetric(
    vertical: Dimens.sixTeen,
    horizontal: Dimens.four,
  );

  static EdgeInsets edgeInsets16_2 = EdgeInsets.symmetric(
    vertical: Dimens.sixTeen,
  ...
  static SizedBox boxHeight9 = SizedBox(
    height: nine,
  );
  ...
  static SizedBox boxWidth27 = SizedBox(
    width: twentyEight,
  );
